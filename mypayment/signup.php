...
$bank = mysqli_real_escape_string($link, $bank);
...
$sql = "INSERT INTO users (`username`, `email`, `password`, `bank`, `balance`, `activation`) VALUES ('$username', '$email', '$password', '$bank', '$balance', '$activationKey')";
$result = mysqli_query($link, $sql);
if(!$result){
...
if(mail($email, 'Confirm your Registration', $message, 'From:'.'s')){
