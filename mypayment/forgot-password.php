...
$message .= "http://mypayments.rajeevchanchlani.com/resetpassword.php?user_id=$user_id&key=$key";
if(mail($email, 'Reset your password', $message, 'From:'.'<mypayments@rajeevchanchlani.com>')){
